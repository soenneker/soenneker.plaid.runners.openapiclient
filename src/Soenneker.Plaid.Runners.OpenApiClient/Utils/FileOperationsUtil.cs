...
using Soenneker.Plaid.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.Plaid.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["Plaid:ClientGenerationUrl"] ?? "https://raw.githubusercontent.com/plaid/plaid-openapi/refs/heads/master/2020-09-14.yml";
        ...
        await _processUtil.Start("kiota", gitDirectory, $"kiota generate -l CSharp -d \"{filePath}\" -o src/{Constants.Library} -c PlaidOpenApiClient -n {Constants.Library}",
